...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const inDownstreamProviderModuleOptions = Object.assign(Object.assign({}, inDownstreamOptions), { cwd: downstreamProviderModuleDir });
            ...
            yield exec_1.exec("go", ["mod", "edit", `-replace=${replace}=${replaceWith}`], inDownstreamProviderModuleOptions);
            yield exec_1.exec("go", ["mod", "download"], inDownstreamProviderModuleOptions);
